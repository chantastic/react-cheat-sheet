...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactCheatSheet = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_ReactCheatSheet2.default, { entries: _data2.default }), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colors = __webpack_require__(161);

	var _colors2 = _interopRequireDefault(_colors);

	var _ReferenceItem = __webpack_require__(162);

	var _ReferenceItem2 = _interopRequireDefault(_ReferenceItem);

	var _CategoryList = __webpack_require__(164);
	...
	var _NoResults = __webpack_require__(167);
	...
	var _lodash5 = __webpack_require__(190);
	  ...
	  _createClass(ReactCheatSheet, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _CategoryList2.default,
	          null,
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.purple,
	            name: 'ReactDOM',
	            active: (0, _lodash2.default)(this.state.categories, "REACTDOM"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.yellow,
	            name: 'Top-level',
	            nameStyle: (0, _lodash2.default)(this.state.categories, "TOPLEVEL") ? { color: "#222" } : null,
	            active: (0, _lodash2.default)(this.state.categories, "TOPLEVEL"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.blue,
	            name: 'Component',
	            active: (0, _lodash2.default)(this.state.categories, "COMPONENT"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.olive,
	            name: 'Spec',
	            active: (0, _lodash2.default)(this.state.categories, "SPEC"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.orange,
	            name: 'Lifecycle',
	            active: (0, _lodash2.default)(this.state.categories, "LIFECYCLE"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.pink,
	            name: 'PropTypes',
	            active: (0, _lodash2.default)(this.state.categories, "PROPTYPES"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.pink,
	            name: 'Test-utils',
	            active: (0, _lodash2.default)(this.state.categories, "TESTUTILS"),
	            onToggle: handleCategoryChange.bind(this)
	          }),
	          _react2.default.createElement(_CategoryButton2.default, {
	            color: _colors2.default.red,
	            name: 'Misc',
	            active: (0, _lodash2.default)(this.state.categories, "MISC"),
	            onToggle: handleCategoryChange.bind(this)
	          })
	        ),
	        _react2.default.createElement(
	          "section",
	          null,
	          this.filteredResults.length ? results() : _react2.default.createElement(_NoResults2.default, null)
	        )
	      );
	    }
	  }, {
	...
	ReactCheatSheet.propTypes = {
	  entries: _react.PropTypes.arrayOf(_react.PropTypes.object).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Prism = __webpack_require__(163);
	...
	var styles = {
	  root: _extends({}, _styles2.default.article, {
	...
	var ReferenceItem = function ReferenceItem(_ref) {
	  ...
	  var refsNotAvailable = _ref.refsNotAvailable;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      refsNotAvailable && _react2.default.createElement(
	        "span",
	        { style: { color: "#e06c75" } },
	        _react2.default.createElement(
	          "strong",
	    ...
	    _react2.default.createElement(
	      ...
	      playground && _react2.default.createElement(
	        ...
	        _react2.default.createElement("i", { className: "my-fa-1.5x my-fa fa fa-code" })
	      ),
	      href && _react2.default.createElement(
	        ...
	        _react2.default.createElement("i", { className: "my-fa-1.5x my-fa fa fa-file-text-o" })
	      )
	    )
	  );
	};
	...
	ReferenceItem.propTypes = {
	  ...
	  chart: _react.PropTypes.element,
	  color: _react.PropTypes.string,
	  notAvailableInComponentClass: _react.PropTypes.bool,
	  cannotCallSetState: _react.PropTypes.bool,
	  refsNotAvailable: _react.PropTypes.bool,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryButton = (function (_Component) {
	  ...
	  _createClass(CategoryButton, [{
	    ...
	    value: function render() {
	      ...
	      var nameStyle = _props.nameStyle;
	...
	CategoryButton.propTypes = {
	  ...
	  nameStyle: _react.PropTypes.shape({
	    color: _react.PropTypes.string
	  }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsEqual = __webpack_require__(180),
	    bindCallback = __webpack_require__(186),
	    isArray = __webpack_require__(181),
	    pairs = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = [].concat(_toConsumableArray(_ReactDOM2.default), _toConsumableArray(_ReactDOM_Server2.default), _toConsumableArray(_React_TopLevel2.default), _toConsumableArray(_React_Component2.default), _toConsumableArray(_React_Spec2.default), _toConsumableArray(_React_Lifecycle2.default), _toConsumableArray(_React_PropTypes2.default), _toConsumableArray(_React_TestUtils2.default), _toConsumableArray(_Misc2.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignSharedDefaults = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LifecycleMethodsChart = function LifecycleMethodsChart(props) {
	  return _react2.default.createElement(
	    "table",
	    null,
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "th",
	          null,
	          "calling setState() triggers an update"
	        )
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      lifecycleMethods.map(function (event, i) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "td",
	            { "data-label": "calling setState() triggers an update" },
